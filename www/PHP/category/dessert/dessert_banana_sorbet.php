                                ...
                                <div >
                                    <div class="content_singleAgent_block">
                                        ...
                                        <ul>
                                            ...
                                            <li>1 кг бананов</li>
                                            <li>400 г лимонов</li>
                                            <li>200 г апельсинов</li>
                                            <li>150 г сахара</li>
                                            <li>200 мл сока (яблочного, виноградного и т.д.)</li>
                                        </ul>
                                    </div>
                                    <div class="content_singleAgent_block">
                                        <h1>Способ приготовления</h1>
                                        <ol>
                                            <li>Лимоны и апельсин почистить.
                                            Удалить косточки.
                                            Положить в блендер.</li>
                                            <li>Измельчить.</li>
                                            <li>Бананы почистить.
                                            Положить в блендер.</li>
                                            <li>Измельчить.</li>
                                            <li>Смешать апельсиново-лимонную и банановую массы.</li>
                                            <li>Добавить сок.
                                            Перемешать.</li>
                                            <li>Добавить сахар.</li>
                                            <li>Перемешать.</li>
                                            <li>Массу перелить в форму, в которой можно замораживать.
                                            Поставить в морозилку на 5–6 часов (лучше на ночь).</li>
                                        </ol>
                                    </div>
                                </div>

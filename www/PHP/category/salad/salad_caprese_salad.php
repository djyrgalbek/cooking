                                ...
                                <div >
                                    <div class="content_singleAgent_block">
                                        ...
                                        <ul>
                                            ...
                                            <li>3–4 шарика моцареллы</li>
                                            <li>3–4 средних помидора</li>
                                            <li>базилик</li>
                                    ...
                                    <div class="content_singleAgent_block">
                                        ...
                                        <ol>
                                            ...
                                            <li>Моцареллу нарезать кружочками.</li>
                                            <li>На тарелку выложить, чередуя, моцареллу и помидоры.</li>
                                            <li>Посолить, поперчить. Полить маслом.</li>
                                            <li>Добавить базилик.</li>         
                                         </ol>
                                    </div>
                                </div>
